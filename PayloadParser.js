function parseUplink(device, payload) {
    ...
    if (decodedMessage.bleDataList != null && Array.isArray(decodedMessage.bleDataList)) {
        for (var i = 0; i < decodedMessage.bleDataList.length; i++) {
            ...
            if (ble && ble.mac === "ee713cc238ab" && ble.temp != null) {
            ...
            if (ble && ble.mac === "ee713cc238ab" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "ee713cc238ab" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "ee713cc238ab" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "ee713cc238ab" && ble.rssi != null) {
            ...
            if (ble && ble.mac === "f1c63ac6c1a5" && ble.temp != null) {
            ...
            if (ble && ble.mac === "f1c63ac6c1a5" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "f1c63ac6c1a5" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "f1c63ac6c1a5" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "f1c63ac6c1a5" && ble.rssi != null) {
